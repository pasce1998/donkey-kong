...
public class DKTestsuiteExtended3 {
  ...
  public static Test suite() {
    TestSuite suite = new TestSuite("Tutor tests for DK - Extended 3");
    
    suite.addTest(new JUnit4TestAdapter(HammerTest.class));
    suite.addTest(new JUnit4TestAdapter(de.tu_darmstadt.informatik.fop.donkeykong.test.tutors.testcases.HammerTest.class));

    suite.addTest(new JUnit4TestAdapter(BonusTest.class));
    suite.addTest(new JUnit4TestAdapter(de.tu_darmstadt.informatik.fop.donkeykong.test.tutors.testcases.BonusTest.class));
