...
public class DKTestsuiteExtended2 {
  ...
  public static Test suite() {
    TestSuite suite = new TestSuite("Tutor tests for DK - Extended 2");
    
    suite.addTest(new JUnit4TestAdapter(GameplayTest.class));
    suite.addTest(new JUnit4TestAdapter(de.tu_darmstadt.informatik.fop.donkeykong.test.tutors.testcases.GameplayTest.class));

    suite.addTest(new JUnit4TestAdapter(InteractionTest.class));
    suite.addTest(new JUnit4TestAdapter(de.tu_darmstadt.informatik.fop.donkeykong.test.tutors.testcases.InteractionTest.class));
