...
public class DKTestsuiteExtended1 {
  ...
  public static Test suite() {
    TestSuite suite = new TestSuite("Tutor tests for DK - Extended 1");
    
    suite.addTest(new JUnit4TestAdapter(HighscoreTest.class));
    suite.addTest(new JUnit4TestAdapter(de.tu_darmstadt.informatik.fop.donkeykong.test.tutors.testcases.HighscoreTest.class));

    suite.addTest(new JUnit4TestAdapter(ScoreTest.class));
    suite.addTest(new JUnit4TestAdapter(de.tu_darmstadt.informatik.fop.donkeykong.test.tutors.testcases.ScoreTest.class));
